...
export function createGoogleDork(query: string, dateFilter: DateFilter, resultLimit: number, sitename: string): string {
...
// Example usage
// const humanQuery = "people facing problems with fitness apps";
// const googleDorkQuery = createGoogleDork(humanQuery, DateFilter.Oldest, 10, 'example.com');

// console.log(googleDorkQuery);
// getresultfun(googleDorkQuery)

// async function getresultfun(q: string) {
//     try {
//       const results = await runApifyActor(q);
